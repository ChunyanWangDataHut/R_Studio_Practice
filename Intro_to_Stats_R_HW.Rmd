...
What you will see are 82 numbers (in that packed display, because we aren鈥檛 
looking at a data frame here), each one representing the sum we鈥檙e after. Take a
...
present$prop_boys = present$boys/present$total*100
